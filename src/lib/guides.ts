...
export const guides: Guide[] = [
  {
    ...
    intro: {
      ...
      zh: [
        ...
        "所以你不需要背下 78 段各自独立的演讲。你需要的是一套稳定的观察方法。当你能分辨大阿尔卡那和小阿尔卡那、圣杯和宝剑、正位的推动感与逆位的阻滞感，整副牌会一下子变得容易读得多。",
      ],
    },
    sections: [
      {
  ...
  },
  {
    ...
    intro: {
      ...
      zh: [
        "Yes or No 塔罗之所以受欢迎，是因为它看起来像一种快速止痛。人在疲惫、焦虑，或卡在选择里时，一个明确答案会显得很有慈悲。问题不在形式本身，而在于很多人把它用在太大、太模糊，或情绪负荷太重的问题上，硬要把它压成简单的二元判断。",
        "更好的做法，是把 Yes or No 塔罗当作一件窄口工具。它适合处理时机、方向、准备度，或者某个选项此刻是否大致被支持。如果答案落在 maybe，不要急着把它拧成 certainty。很多时候，maybe 的意思并不是“没用”，而是“这里有流动，但下一步要看你怎么做”。",
      ],
    },
    sections: [
      {
        ...
        paragraphs: {
          ...
          zh: [
            ...
            "它不太适合那种体量过大的提问，比如：这个人会不会是我一生的灵魂伴侣？或者：我下个月辞职，整个人生会不会彻底翻盘？问题一旦太大，牌通常给出的就不是二元答案，而是复杂性；这时硬逼出 yes/no，反而更容易误导。",
          ],
        },
      },
      {
      ...
      },
      {
        ...
        paragraphs: {
          ...
          zh: [
            ...
            "所以拿到 maybe 时，不要把它当成失败。把它当成一个提示：你该追问得更好了。什么条件成熟之后，这件事才会变成 yes？我又忽略了什么，才让它此刻还是 no？",
          ],
        },
      },
      {
        ...
        paragraphs: {
          ...
          zh: [
            ...
            "换句话说，补牌是为了修整，不是为了抢救。当一个问题在结构上就比 yes/no 更复杂时，换成更大的牌阵并不是“小题大做”，而只是换回合适的工具。",
          ],
        },
      },
    ],
  ...
  },
  {
    ...
    intro: {
      ...
      zh: [
        ...
        "而这段故事不一定非得是过去、现在、未来，虽然这是最常见的读法。三张牌也可以读成：现状、阻碍、建议；选项 A、选项 B、你真正需要知道的；或者身、心、灵。重要的不是标签本身，而是这些位置能不能帮你把问题问得更干净。",
      ],
    },
    sections: [
      {
